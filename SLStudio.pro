...
win32 {
    ...
    # opencv
    INCLUDEPATH += F:\Opencv_Development\opencv\install\include

    CONFIG(debug,debug|release){
        #debug
        LIBS += -LF:\Opencv_Development\opencv\install\x64\vc12\lib \
                -lopencv_core249d \
                -lopencv_highgui249d \
                -lopencv_imgproc249d \
                -lopencv_calib3d249d
    ...
    # pcl
    INCLUDEPATH += F:\StructLight\slstudio-master\Install\PCL1.8\include\pcl-1.8

    CONFIG(debug,debug|release){
        #debug
        LIBS += -LF:\StructLight\slstudio-master\Install\PCL1.8\lib \
    ...
    # pcl dependencies
    INCLUDEPATH += F:\BOOST-1.61-vc120-x64 \
                   F:\StructLight\slstudio-master\Install\eigen-3.2.8 \
                   F:\StructLight\slstudio-master\Install\flann-1.8\include
    LIBS += -LF:\BOOST-1.61-vc120-x64\lib -lboost_system-vc120-mt-1_61 -lboost_system-vc120-mt-gd-1_61
    ...
    CONFIG(debug,debug|release){
    #debug
    LIBS += -LF:\VTKandITK\VTK\vtk\debug\lib \
    ...
    # release
    LIBS += -LF:\VTKandITK\VTK\vtk\release\lib \
            -lvtkGUISupportQt-7.0 \
            -lvtkImagingCore-7.0 \
            -lvtkCommonCore-7.0 \
            -lvtkCommonDataModel-7.0 \
...
win32{
    ...
    INCLUDEPATH += F:\StructLight\slstudio-master\thirdParty\glew-2.0.0\include
    LIBS += -LF:\StructLight\slstudio-master\thirdParty\glew-2.0.0\lib\Release\x64 -lglew32
}
#macx{
#    CONFIG += objective_c
...
win32:exists(F:\PointGreyResearch\FlyCapture2\include\FlyCapture2.h){
    DEFINES += WITH_CAMERAPOINTGREY
    INCLUDEPATH += F:\PointGreyResearch\FlyCapture2\include
    LIBS += -LF:\PointGreyResearch\FlyCapture2\lib64 -lFlyCapture2
}
